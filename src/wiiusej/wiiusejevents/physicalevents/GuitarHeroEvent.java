...
public class GuitarHeroEvent extends ExpansionEvent
{
	 ...
	 */
	public GuitarHeroEvent(int id, short buttonsJustPressed, short buttonsJustReleased,
			...
			short max2, short min1, short min2, short center1, short center2)
	{
		...
		buttonsEvent = new GuitarHeroButtonsEvent(id, buttonsJustPressed, buttonsJustReleased,
				buttonsHeld);
		guitarHeroJoystickEvent = new JoystickEvent(id, angle, magnitude, max1, max2, min1, min2,
				center1, center2);
	 ...
	 * 
	 * @return the guitar hero controller joystick Event if there is one or
	 *         null.
	 */
