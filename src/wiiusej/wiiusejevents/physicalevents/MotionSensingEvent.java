...
public class MotionSensingEvent extends GenericEvent
{
	 ...
	 */
	public MotionSensingEvent(int id, float orientationThreshold, int accelerationThreshold,
	 ...
	 *            raw acceleration on z axis
	 */
	private void setOrientationAndGforce(float r, float p, float ya, float ar, float ap, float x,
