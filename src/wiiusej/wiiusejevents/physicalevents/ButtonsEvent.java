...
public abstract class ButtonsEvent extends GenericEvent
{
	 ...
	 *            buttons just held.
	 */
	public ButtonsEvent(int id, short buttonsJustPressed, short buttonsJustReleased,
			short buttonsHeld)
	{
		super(id);
	 ...
	 * @param buttonsHeld
	 */
	private void setAllButtons(short buttonsJustPressed, short buttonsJustReleased,
			short buttonsHeld)
	{
