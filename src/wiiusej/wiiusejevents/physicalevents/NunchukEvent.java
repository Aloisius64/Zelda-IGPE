...
public class NunchukEvent extends ExpansionEvent
{
	 ...
	 */
	public NunchukEvent(int id, short buttonsJustPressed, short buttonsJustReleased,
	...
	{
		super(id);
		buttonsEvent = new NunchukButtonsEvent(id, buttonsJustPressed, buttonsJustReleased,
				buttonsHeld);
		nunchukMotionSensingEvent = new MotionSensingEvent(id, orientationThreshold,
				accelerationThreshold, smoothingState, alphaSmooth, r, p, ya, ar, ap, x, y, z, xx,
				yy, zz);
		nunchukJoystickEvent = new JoystickEvent(id, angle, magnitude, max1, max2, min1, min2,
				center1, center2);
	}
