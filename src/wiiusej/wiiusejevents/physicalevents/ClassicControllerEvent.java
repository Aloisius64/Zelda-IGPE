...
public class ClassicControllerEvent extends ExpansionEvent
{
	 ...
	 */
	public ClassicControllerEvent(int id, short buttonsJustPressed, short buttonsJustReleased,
			...
			short rmin2, short rcenter1, short rcenter2)
	{
		...
		buttonsEvent = new ClassicControllerButtonsEvent(id, buttonsJustPressed,
				buttonsJustReleased, buttonsHeld);
		classicControllerLeftJoystickEvent = new JoystickEvent(id, langle, lmagnitude, lmax1,
				lmax2, lmin1, lmin2, lcenter1, lcenter2);
		classicControllerRightJoystickEvent = new JoystickEvent(id, rangle, rmagnitude, rmax1,
	 ...
	 * 
	 * @return the classic controller right Joystick Event if there is one or
	 *         null.
	 */
	 ...
	 * 
	 * @return the classic controller left Joystick Event if there is one or
	 *         null.
	 */
	...
	public String toString()
	{
		String out = "";
		/* Status */
		out += "/*********** Classic Controller EVENT : WIIMOTE   ID :" + getWiimoteId()
				+ " ********/\n";
		out += buttonsEvent;
