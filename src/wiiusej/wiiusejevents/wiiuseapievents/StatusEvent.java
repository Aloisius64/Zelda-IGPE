...
public class StatusEvent extends WiiUseApiEvent
{
	 ...
	 */
	public StatusEvent(int id, boolean connect, float batt, short led, boolean speak, int attach,
			boolean rumbleState, boolean continuousState, boolean irState,
	 ...
	 * 
	 * @return true if a classic controller is connected to the wiimote false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return true if a guitar hero controllerr is connected to the wiimote
	 *         false otherwise.
	 */
	...
	public String toString()
	{
		String out = "";
		/* Status */
		out += "/*********** STATUS EVENT : WIIMOTE ID :" + super.getWiimoteId() + " ********/\n";
