...
public class WiiuseJGuiTest extends javax.swing.JFrame implements WiimoteListener
{
	...
	private void initComponents()
	{
		...
		irViewPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(
				new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 153), 2, true),
				"IR View", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 0, 51)));
		...
		irViewPanelLayout.setHorizontalGroup(irViewPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 272, Short.MAX_VALUE));
		irViewPanelLayout.setVerticalGroup(irViewPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 299, Short.MAX_VALUE));
		...
		accelerationPanelLayout.setHorizontalGroup(accelerationPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 279, Short.MAX_VALUE));
		accelerationPanelLayout.setVerticalGroup(accelerationPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 213, Short.MAX_VALUE));
		...
		motionSensingPanelLayout.setHorizontalGroup(motionSensingPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 279, Short.MAX_VALUE));
		motionSensingPanelLayout.setVerticalGroup(motionSensingPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 213, Short.MAX_VALUE));
		...
		gForcePanelLayout.setHorizontalGroup(gForcePanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 279, Short.MAX_VALUE));
		gForcePanelLayout.setVerticalGroup(gForcePanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 213, Short.MAX_VALUE));
		...
		leftPanelLayout.setHorizontalGroup(leftPanelLayout
				...
				.addComponent(irViewPanel, javax.swing.GroupLayout.Alignment.TRAILING,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
				.addComponent(jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 284,
						Short.MAX_VALUE));
		leftPanelLayout.setVerticalGroup(leftPanelLayout.createParallelGroup(
				...
				leftPanelLayout
						...
						.addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 238,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(irViewPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
		...
		rightPanel
				.setLayout(new javax.swing.BoxLayout(rightPanel, javax.swing.BoxLayout.LINE_AXIS));
		...
		buttonsPanelLayout.setHorizontalGroup(buttonsPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 120, Short.MAX_VALUE));
		buttonsPanelLayout.setVerticalGroup(buttonsPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 484, Short.MAX_VALUE));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						.addComponent(leftPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(rightPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 498,
								Short.MAX_VALUE)));
		layout.setVerticalGroup(layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(leftPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addComponent(rightPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 573,
						Short.MAX_VALUE));
	...
	{// GEN-FIRST:event_toggleRumbleButtonMousePressed
	...
	{// GEN-FIRST:event_toggleIRTrackingButtonMousePressed
	...
	{// GEN-FIRST:event_toggleMotionSensingTrackingButtonMousePressed
	...
	{// GEN-FIRST:event_toggleSmoothingButtonMousePressed
	...
	{// GEN-FIRST:event_toggleContinuousButtonMousePressed
	...
	{// GEN-FIRST:event_led1ButtonMousePressed
	...
	{// GEN-FIRST:event_led2ButtonMousePressed
	...
	{// GEN-FIRST:event_led3ButtonMousePressed
	...
	{// GEN-FIRST:event_led4ButtonMousePressed
	...
	{// GEN-FIRST:event_setLedsButtonMousePressed
		wiimote.setLeds(led1Button.isEnabled(), led2Button.isEnabled(), led3Button.isEnabled(),
				led4Button.isEnabled());
	...
	{// GEN-FIRST:event_alphaSmoothingButtonMousePressed
		try
		{
	...
	{// GEN-FIRST:event_orientationThresholdButtonMousePressed
		try
		{
	...
	{// GEN-FIRST:event_accelerationThresholdButtonMousePressed
		try
		{
	...
	{// GEN-FIRST:event_getStatusButtonMousePressed
		wiimote.getStatus();
	...
	{// GEN-FIRST:event_toggleSensorBarPositionButtonMousePressed
	...
	{// GEN-FIRST:event_toggleScreenAspectRatioButtonMousePressed
	...
	{// GEN-FIRST:event_setVirtualResolutionButtonMousePressed
		try
		{
	...
	{// GEN-FIRST:event_mouseIRControlButtonMousePressed
	...
	{// GEN-FIRST:event_normalTimeoutSpinnerStateChanged
	...
	{// GEN-FIRST:event_expansionHandshakeTimeoutSpinnerStateChanged
	...
	{// GEN-FIRST:event_setIrSensitivySpinnerStateChanged
	...
	{// GEN-FIRST:event_setIrSensitivyButtonMousePressed
		String value = setIrSensitivySpinner.getValue().toString();
		boolean isInt = true;
		int valueInt = 0;
		try
	...
	{// GEN-FIRST:event_setTimeoutButtonMousePressed
		// get normal timeout
		String value = normalTimeoutSpinner.getValue().toString();
		boolean isInt = true;
		short valueInt = 0;
		...
		if (isInt && isInt2)
		{
			if (valueInt > 0 && valueInt2 > 0)
			{
				...
				messageText.setText("Normal timeout set to: " + valueInt
						+ " and expansion handshake timeout set to: " + valueInt2 + "!");
			}
			else
			{
				messageText
	...
	{// GEN-FIRST:event_reconnectWiimotesButtonMousePressed
		// stop manager
	...
	{// GEN-FIRST:event_showExpansionWiimoteButtonMousePressed
		if (expansionFrame != null)
		{
			if (showExpansionWiimoteButton.isEnabled())
			{// expansion frame
				// not shown
				// show it
