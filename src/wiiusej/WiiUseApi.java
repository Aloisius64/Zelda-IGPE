...
public class WiiUseApi
{
	 ...
	 */
	synchronized native void setLeds(int id, boolean led1, boolean led2, boolean led3, boolean led4);
	 ...
	 *            handshake.
	 */
	synchronized native void setTimeout(int id, short normalTimeout, short expansionTimeout);
