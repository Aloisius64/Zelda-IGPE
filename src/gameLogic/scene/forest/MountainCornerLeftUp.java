...
public class MountainCornerLeftUp extends AbstractObjectScene
{
	@Override
	...
	public MountainCornerLeftUp(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.MOUNTAIN_CORNER_LEFT_UP);
	}
