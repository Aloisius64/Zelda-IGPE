...
public class WaterAngleDownRight extends AbstractObjectScene
{
	@Override
	...
	public WaterAngleDownRight(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.WATER_ANGLE_DOWN_RIGHT);
	}
