...
public class WaterAngleDownLeft extends AbstractObjectScene
{
	@Override
	...
	public WaterAngleDownLeft(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.WATER_ANGLE_DOWN_LEFT);
	}
