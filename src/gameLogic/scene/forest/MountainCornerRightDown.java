...
public class MountainCornerRightDown extends AbstractObjectScene
{
	@Override
	...
	public MountainCornerRightDown(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.MOUNTAIN_CORNER_RIGHT_DOWN);
	}
