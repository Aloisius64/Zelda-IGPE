...
public class WaterAngleUpLeft extends AbstractObjectScene
{
	@Override
	...
	public WaterAngleUpLeft(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.WATER_ANGLE_UP_LEFT);
	}
