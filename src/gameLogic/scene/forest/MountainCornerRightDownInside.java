...
public class MountainCornerRightDownInside extends AbstractObjectScene
{
	@Override
	...
	public MountainCornerRightDownInside(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.MOUNTAIN_CORNER_RIGHT_DOWN_INSIDE);
	}
