...
public class MountainCornerLeftDown extends AbstractObjectScene
{
	@Override
	...
	public MountainCornerLeftDown(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.MOUNTAIN_CORNER_LEFT_DOWN);
	}
