...
public class MountainCornerRightUp extends AbstractObjectScene
{
	@Override
	...
	public MountainCornerRightUp(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.MOUNTAIN_CORNER_RIGHT_UP);
	}
