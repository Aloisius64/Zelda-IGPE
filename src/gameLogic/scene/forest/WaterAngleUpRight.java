...
public class WaterAngleUpRight extends AbstractObjectScene
{
	@Override
	...
	public WaterAngleUpRight(int xPosition, int yPosition)
	{
		super(xPosition, yPosition);
		setId(StaticConstantID.WATER_ANGLE_UP_RIGHT);
	}
